...
def main():
    # 1. Load the dynamic list of feeds from the cloud configuration
    ...
    # 2. Load the existing master archive
    ...
    # 3. Fetch from the dynamic feed list
